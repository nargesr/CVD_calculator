...
<!--<ul class="top">-->
<!--    <li class="hover"><a href="second_page_fa.php">فارسی</a></li>-->
<!--    <li class="hover"><a href="second_page.php">انگلیسی</a></li>-->
<!--</ul>-->
<div class="container font">
    ...
    <div class="row">
        <div class="col-md-3 col-md-offset-2 text-center alert alert-success">
            ...
            <p dir="rtl">ریسک ۱۰ساله‌ی امکان حمله قلبی</p>
            <p dir="rtl"><a href="">چگونه بیماری خود را دنبال کنیم؟</a></p>
        </div>
        <div class="col-md-3 col-md-offset-2 text-center alert alert-success">
            <h1>
                <?php
            ...
            <p dir="rtl">امتیاز ریسک Framingham</p>
        </div>
    </div>
    ...
    <table class="table" align="right" dir="rtl" style="direction:rtl;text-align:right;">
        <tr dir="rtl">
            <td><b>اطلاعات شخصی</b></td>
            <td><b>چربی</b></td>
            <td><b>فشار خون</b></td>
            <td><b>فاکتورهای خطر</b></td>
        </tr>
        ...
        <tr dir="rtl">
            ...
            <td>کل: <?php
                ...
                ?></td>
            <td>فشار خون حداکثر: <?php
                echo $_POST["sbp"];
                ?></td>
            <td>دیابت: <?php
                $diabetes = $_POST["diabetes"];
                if ($diabetes == 1) {echo "بله";}
                else{echo "خیر";}
                ?></td>
        </tr>
        ...
        <tr dir="rtl">
            <td>جنسیت: <?php
                $gender = $_POST["gender"];
                if ($gender == 1) {echo "مذکر";}
                else{echo "مونث";}
                ?></td>
            <td>چربی خوب: <?php
                echo $_POST["hdl"];
                ?></td>
            <td>فشار خون حداقل: <?php
                echo $_POST["dbp"];
                ?></td>
            <td>سیگاری: <?php
                $smoker = $_POST["smoker"];
                if ($smoker == 1) {echo "بله";}
                else{echo "خیر";}
                ?></td>
        </tr>
    </table>
